...
import com.dasasergeeva.focusleaf2.databinding.FragmentOnboarding0Binding

/**
 * Фрагмент первого экрана онбординга
 * Показывает логотип приложения и подзаголовок
 */
